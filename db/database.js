...
const addQuiz = function (quiz) {
  ...
  return db
    .query(`INSERT INTO quizzes (title, privacy_setting, url, number_of_questions) VALUES ($1, $2, $3, $4) RETURNING *`, [quiz.title, quiz.privacy_setting, url, quiz.number_of_questions])
    .then((result) => {
